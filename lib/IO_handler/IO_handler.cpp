    ...
    , m_d_out(PC_8)
{
    m_a_out.write(0.0f);
    m_set_value = 0.0f;
    m_lc_in = LinearCharacteristics(0.0f, 1.0f, -1.0f, 1.0f);  // map [0,1] to [0,3.3]
    m_lc_out = LinearCharacteristics(-1.0f, 1.0f, 0.0f, 1.0f);  // map [0,1] to [0,3.3]
}
